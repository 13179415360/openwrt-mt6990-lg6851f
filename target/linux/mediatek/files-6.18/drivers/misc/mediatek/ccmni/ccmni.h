...
#define ENABLE_RENAME_CCMNI_WAN_DEVNAME
int is_ccmni_netdev(char *devname);
int get_ccmni_orig_index(struct net_device *dev);

/* #define ENABLE_DEFERRED_IP_ALLOCATION */
#if defined(ENABLE_DEFERRED_IP_ALLOCATION)
#define DHCP_SERVER_PORT 67
#define DHCP_CLIENT_PORT 68
// Multiple clients use DHCP Reply msg
#define DHCP_MAX_ENTRIES 100
struct dhcp_addr_tbl {
...
#define MAX_MTU                 3000
#ifdef CONFIG_MTK_ETHERNET_PDU
#define  CCMNI_MTU              1522
#else
#if defined(CONFIG_MTK_WAN_MTU_SIZE)
#define CCMNI_MTU          CONFIG_MTK_WAN_MTU_SIZE
#else
...
struct ccmni_instance {
	...
	unsigned char idu_mac_addr[MAX_ADDR_LEN];
	struct proc_dir_entry *proc_idu_mac;
#if defined(CCMNI_MET_DEBUG)
