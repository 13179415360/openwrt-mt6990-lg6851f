...
extern int __weak free_reserved_memory(phys_addr_t start_phys,
				       phys_addr_t end_phys);
extern void inject_md_status_event(int md_id, int event_type, char reason[]);
extern void get_ccci_aee_buffer(unsigned long *vaddr, unsigned long *size);
extern void get_md_aee_buffer(unsigned long *vaddr, unsigned long *size);
