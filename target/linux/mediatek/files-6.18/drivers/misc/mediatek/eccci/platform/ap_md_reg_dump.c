 ...
 * Date 2020-07-20 13:01:05.291724
 */
static void __iomem *dump_AP_MDSRC_REQ;
static void __iomem *PC_Monitor;
static void __iomem *PLL_reg_clock_control;
static void __iomem *BUS;
static void __iomem *BUSMON_;
...
struct dump_reg_ioremap dump_reg_tab[] = {
	{&dump_AP_MDSRC_REQ,0x10006434, 0x4},
	{&PC_Monitor,0x0D11C000, 0x21B0},
	{&PLL_reg_clock_control,0x0D103800, 0x248A0},
	{&BUS,0x0D102000, 0x37140},
	{&BUSMON_,0x0D108000, 0x30F24},
	{&ECT,0x0D101100, 0xCF48},
	{&TOPSM_reg,0x0D110000, 0x8E8},
	{&MD_RGU_reg,0x0D112100, 0x25C},
	{&OST_status,0x0D111000, 0x20C},
	{&CSC_reg,0x0D113000, 0x224},
	{&USIP,0x0D104400, 0x52478}
};

void internal_md_dump_debug_register(unsigned int md_index)
{
	void __iomem *dump_reg0 = NULL;
	...
	/* PLL_reg_clock_control */
	dump_reg0 = ioremap(0x0D103800, 0x248A0);
	if (dump_reg0 == NULL) {
		CCCI_MEM_LOG_TAG(md_index, TAG,
	...
	/* BUS */
	dump_reg0 = ioremap(0x0D102000, 0x37140);
	if (dump_reg0 == NULL) {
		CCCI_MEM_LOG_TAG(md_index, TAG,
	...
	/* BUSMON_ */
	dump_reg0 = ioremap(0x0D108000, 0x30F24);
	if (dump_reg0 == NULL) {
		CCCI_MEM_LOG_TAG(md_index, TAG,
	...
	/* ECT */
	dump_reg0 = ioremap(0x0D101100, 0xCF48);
	if (dump_reg0 == NULL) {
		CCCI_MEM_LOG_TAG(md_index, TAG,
	...
	/* TOPSM_reg */
	dump_reg0 = ioremap(0x0D110000, 0x8E8);
	if (dump_reg0 == NULL) {
		CCCI_MEM_LOG_TAG(md_index, TAG,
	...
	/* MD_RGU_reg */
	dump_reg0 = ioremap(0x0D112100, 0x25C);
	if (dump_reg0 == NULL) {
		CCCI_MEM_LOG_TAG(md_index, TAG,
	...
	/* OST_status */
	dump_reg0 = ioremap(0x0D111000, 0x20C);
	if (dump_reg0 == NULL) {
		CCCI_MEM_LOG_TAG(md_index, TAG,
	...
	/* CSC_reg */
	dump_reg0 = ioremap(0x0D113000, 0x224);
	if (dump_reg0 == NULL) {
		CCCI_MEM_LOG_TAG(md_index, TAG,
	...
	/* USIP */
	dump_reg0 = ioremap(0x0D104400, 0x52478);
	if (dump_reg0 == NULL) {
		CCCI_MEM_LOG_TAG(md_index, TAG,
