...
#define CCIF_MBIM_Q 3  // for modem manager

#ifndef DATA_PLANE_DPMAIF  //For data card
#define EXP_CTRL_Q		6
...
/* ttyCMIPC0 ~ 9 */
	{CCCI_MIPC0_CHANNEL_TX, CCCI_MIPC0_CHANNEL_RX,
		CCIF_L5_Q, CCIF_L5_Q, 0xFF, 0xFF, MD1_NORMAL_HIF,
	...
	{CCCI_MIPC11_CHANNEL_TX, CCCI_MIPC11_CHANNEL_RX,
		CCIF_L5_Q, CCIF_L5_Q, 0xFF, 0xFF, MD1_NORMAL_HIF,
		(PORT_F_WITH_CHAR_NODE|PORT_F_CH_TRAFFIC|PORT_F_DUMP_RAW_DATA),
		&char_port_ops, 23, "ttyCMIPC11",},
	{CCCI_MIPC12_CHANNEL_TX, CCCI_MIPC12_CHANNEL_RX,
		CCIF_L5_Q, CCIF_L5_Q, 0xFF, 0xFF, MD1_NORMAL_HIF,
		(PORT_F_WITH_CHAR_NODE|PORT_F_CH_TRAFFIC|PORT_F_DUMP_RAW_DATA),
		&char_port_ops, 24, "ttyCMIPC12",},
	{CCCI_MIPC13_CHANNEL_TX, CCCI_MIPC13_CHANNEL_RX,
		CCIF_L5_Q, CCIF_L5_Q, 0xFF, 0xFF, MD1_NORMAL_HIF,
		(PORT_F_WITH_CHAR_NODE|PORT_F_CH_TRAFFIC|PORT_F_DUMP_RAW_DATA),
		&char_port_ops, 25, "ttyCMIPC13",},
	{CCCI_MIPC14_CHANNEL_TX, CCCI_MIPC14_CHANNEL_RX,
		CCIF_L5_Q, CCIF_L5_Q, 0xFF, 0xFF, MD1_NORMAL_HIF,
		(PORT_F_WITH_CHAR_NODE|PORT_F_CH_TRAFFIC|PORT_F_DUMP_RAW_DATA),
		&char_port_ops, 26, "ttyCMIPC14",},

#if ((DATA_PLANE_TYPE == 1) || (DATA_PLANE_TYPE == 3))
	{CCCI_MBIM_CHANNEL_TX, CCCI_MBIM_CHANNEL_RX,
		CCIF_MBIM_Q, CCIF_MBIM_Q, 0xFF, 0xFF, MD1_NORMAL_HIF,
		(PORT_F_WITH_CHAR_NODE|PORT_F_CH_TRAFFIC|PORT_F_DUMP_RAW_DATA),
		&char_port_ops, 29, "ttyCMBIM",},

	{CCCI_UART2_TX, CCCI_UART2_RX, CCIF_L5_Q , CCIF_L5_Q , 0xFF, 0xFF,
		MD1_NORMAL_HIF, PORT_F_WITH_CHAR_NODE,
		&char_port_ops, 30, "ttyC0",},
#endif
...
/* smem port */
	...
	{CCCI_CCMNI8_TX, CCCI_CCMNI8_RX, DATA1_TX_Q, DATA_RX_Q,
		0xF0 | DATA_TX_ACK_Q, 0xFF, MD1_NET_HIF, 0,
		&net_port_ops, 7, "ccmni7",},
	{CCCI_CCMNI9_TX, CCCI_CCMNI9_RX, DATA1_TX_Q, DATA_RX_Q,
		0xF0 | DATA_TX_ACK_Q, 0xFF, MD1_NET_HIF, 0,
		&net_port_ops, 8, "ccmni8",},
