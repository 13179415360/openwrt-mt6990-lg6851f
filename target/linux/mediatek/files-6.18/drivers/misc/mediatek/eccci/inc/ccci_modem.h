...
enum{
	...
	CCCI_FAST_HEADER = 22,
	MISC_INFO_HIF_32K_LOW_POWER=23, /* CCMSG_ID_MISCINFO_SLPHISTLOG */
	...
	// colgin @{
	//MEMORY_REMAP_INFO = 38,  // relpase by MD_MEM_AP_VIEW_INF
	SAP_MEMDUMP_SHARE_MEMORY = 39,
	SAP_EXCEPTION_RECORD_SHARE_MEMORY = 40,
	MISC_INFO_EAP_FEATURE = 41,
	DPMF_USB_PATH_SHARE_MEMORY = 42,
	RUNTIME_SHARE_MEMORY_MIDR = 43,
	CCCI_DHL_MISC_INFO = 44,
	// @}
	AMMS_DRDI_COPY = 45,  // AMMS_v3
	AEE_OFF_FAST_REBOOT = 49,  // fast reboot after EE
	CCCI_DHL_MISC_INFO_V2 = 50,
	SAR_IDX = 52,
	DRDI_RT_DATA = 53,
...
/* sync debug config of AEE to DHL (CCCI_DHL_MISC_INFO) */
struct aee_dhl_dump_config {
	u8 mini_dump_flag;
	u8 midr_dump_flag;
	u16 reserved;
};

/* sync fast reboot flag to MD exp flow */
struct aee_off_fast_reboot_config {
	u8 fast_reboot_flag;
	u8 reserved;
	u16 reserved1;
};
