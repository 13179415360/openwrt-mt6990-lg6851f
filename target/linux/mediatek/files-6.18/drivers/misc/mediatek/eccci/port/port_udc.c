...
static int udc_resp_msg_to_md(struct port_t *port,
...
static void udc_cmd_check(struct port_t *port,
...
static int udc_actv_handler(struct z_stream_s *zcpr,
...
static int udc_deflate(struct z_stream_s *zcpr, u32 inst_id, u32 con,
	unsigned char *uncomp_data, unsigned int uncomp_len,
...
static int udc_kick_handler(struct port_t *port, struct z_stream_s *zcpr,
...
static int udc_restore_skb(struct port_t *port,
