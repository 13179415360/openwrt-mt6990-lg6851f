...
#define R_CORE0_KICKREG		(scpreg.cfg_core0 + 0x0038)
#define R_CORE1_KICKREG		(scpreg.cfg_core1 + 0x0038)
	#define V_INSTANT_WDT	0x80000000
	#define V_DISABLE_WDT	0x000FFFFF
	#define V_START_WDT 	0x800FFFFF
	#define V_KICK_WDT 0x1
...
#define SCP_SET_CLK_CG				(scpreg.clkctrl + 0x0030) /* medmcu CLK_CG */
